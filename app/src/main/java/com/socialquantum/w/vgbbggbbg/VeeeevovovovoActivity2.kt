package com.socialquantum.w.vgbbggbbg
...
import com.socialquantum.w.databinding.ActivityVeeeevovovovo2Binding
...
class VeeeevovovovoActivity2 : AppCompatActivity() {
    ...
    inner class NKjfhurfrfhurfhurf : WebViewClient() {
        ...
        override fun onReceivedError(
            ...
            Toast.makeText(this@VeeeevovovovoActivity2, description, Toast.LENGTH_SHORT).show()
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        htmklhymklhymhykohy = ActivityVeeeevovovovo2Binding.inflate(layoutInflater)
    ...
    private lateinit var htmklhymklhymhykohy: ActivityVeeeevovovovo2Binding
