...
class FouuururururFragment : Fragment() {

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.fragment_fouuurururur, container, false)
    }
    ...
    private fun gtjiogtjigtjijigt() {
        findNavController().navigate(R.id.action_fouuururururFragment_to_fivivieveiveiveiveFragment)
    }
